...
perspective, noise, uneven light — must recover all 296 cells."""
import pytest

from bootstrap import (fill_all_cells, norm_iou, ref_render,
                       synthesize_photo)
...
def test_b2_paper_roundtrip(tmp_path):
    ...
    for i in range(1, 15):
        ...
        synthesize_photo(sheets / f"S{i}.png", photo, seed=100 + i)
